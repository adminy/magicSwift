...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        urlTextfield.text = "https://www.youtube.com/watch?v=GZjt_sA2eso"
...
//        let video = HCYoutubeParser.h264videos(withYoutubeURL:  URL(string: urlTextfield.text!))?.first?.value
// 
//        
//        statusLabel.text = video as? String
